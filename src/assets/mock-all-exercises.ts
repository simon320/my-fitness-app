export const mockAllExercises = [
    ...
    },
    {
        ...
        "instructions": [
            ...
            "Mantén los codos pegados al torso y la parte superior de los brazos inmóvil durante todo el movimiento.",
            "Exhala mientras levantas las pesas y contraes los bíceps. Continúa subiendo la barra hasta que los bíceps estén completamente contraídos y la barra esté a la altura de los hombros.",
            "Mantén la posición contraída durante una breve pausa mientras aprietas los bíceps.",
            "Inhala mientras vuelves lentamente la barra a la posición inicial.",
